 ...
 */
public class DiandianBlogProcessor implements IPageProcessor {
    ...
    public Site getSite() {
        //site定义抽取配置，以及开始url等
        if (site == null) {
            site = Site.create().setDomain("progressdaily.diandian.com").addStartUrl("http://progressdaily.diandian.com/").
