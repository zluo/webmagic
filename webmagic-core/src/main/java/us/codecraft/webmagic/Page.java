...
public class Page {
     ...
     * @param requestString
     */
    private void addTargetRequest(String requestString, long priority) {
	addTargetRequest(buildRequest(requestString,priority));
    }
    
    public void addTargetRequest(String requestString) {
	addTargetRequest(buildRequest(requestString,0));
    }
    
    private Request buildRequest(String s, long priority) {
	if (StringUtils.isBlank(s) || s.equals("#") || s.startsWith("javascript:")) {
	    return null;
	}
	return new Request(UrlUtils.canonicalizeUrl(s, url.toString())).setPriority(priority);
    }
